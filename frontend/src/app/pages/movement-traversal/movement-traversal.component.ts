...
export class MovementTraversalComponent implements OnInit {
  ...
  // farm + species dropdowns are built from movement data (source/destination
  // farms and species seen in any movement), not the role-scoped /api/farms
  // endpoint — that one blocks reviewers entirely, but movements are visible
  // to every role
